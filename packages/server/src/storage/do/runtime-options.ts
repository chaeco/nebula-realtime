...
export const resolveRuntimeConfig = (
  ...
  rateLimitDisconnectThreshold: parseIntHeader(
    request,
    'x-nebula-rate-limit-disconnect-threshold',
    current.rateLimitDisconnectThreshold,
    1,
    20
  ),
  rateLimitViolationWindowMs: parseIntHeader(
    request,
    'x-nebula-rate-limit-violation-window-ms',
    current.rateLimitViolationWindowMs,
    1000,
    3_600_000
  ),
  idempotencyCacheSize: parseIntHeader(
    request,
    'x-nebula-idempotency-cache-size',
    current.idempotencyCacheSize,
    1,
    10_000
  ),
  idempotencyTTLSeconds: parseIntHeader(
    request,
    'x-nebula-idempotency-ttl-seconds',
    current.idempotencyTTLSeconds,
    1,
    86_400
  ),
